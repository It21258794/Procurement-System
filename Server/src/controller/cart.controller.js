...
var createCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var cartDetails, order, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                console.log(req.body);
                cartDetails = new cart_model_1.default(req.body);
                return [4 /*yield*/, cart_service_1.default.createCart(cartDetails)];
            case 1:
                order = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cart_service_1.default.getCartItems()];
            case 1:
                items = _a.sent();
...
var clearCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemId, isDeleted, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                itemId = req.params.itemId;
                return [4 /*yield*/, cart_service_1.default.clearCart(itemId)];
            case 1:
                isDeleted = _a.sent();
...
var updateCartItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var itemId, updatedData, updatedItem, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, cart_service_1.default.updateCartItem(itemId, updatedData)];
            case 1:
                updatedItem = _a.sent();
